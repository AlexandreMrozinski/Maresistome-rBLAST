...
bar_plot_combinedgenresclasses <- ggplot(top_genres_combined3, aes(x = reorder(Genus, -Count), y = Count, fill = Ville)) +
  ...
  annotate("text", x = 38, y = 10, label = paste("\nTotal de séquences pour Verveur:", total_sequencesVerveur, "\nNombre de genres pour Verveur:", total_genresVerveur, "\nTotal de séquences pour Barnenez:", total_sequencesBarnenez, "\nNombre de genres pour Barnenez:", total_genresBarnenez, "\nNombre total de genres pour les deux sites combinés:", total_genres_combined3), hjust = 1, vjust = -0.1, size = 7) +
  theme(legend.position = "right", 
        legend.text = element_text(size = 15), # Modifier la taille de la légende
        axis.title.y = element_text(size = 25), # Modifier la taille du titre de l'axe des ordonnées
        axis.text.y = element_text(size = 15), # Modifier la taille des chiffres de l'axe des ordonnées
        plot.title = element_text(size = 25, hjust = 0.5)) + # Modifier la taille du titre du graphique et centrer
...
de séquences :") + # Modifier le titre de la légende
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 25), # genres
        axis.text.y = element_text(size = 20), # légende heatmap axe des ordonnées
        plot.title = element_text(hjust = 0.5),
        legend.text = element_text(size = 15), # Modifier la taille du texte de la légende (légende du code couleur)
        legend.title = element_text(size = 15), # Modifier la taille du titre de la légende (nb de séquences)
