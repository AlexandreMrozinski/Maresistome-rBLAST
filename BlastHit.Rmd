...
venn_plotBarnenez <- ggvenn(sets_listBarnenez, show_elements = TRUE,
  ...
  set_name_size = 2,  # Ajustez la taille de la police ici BarnenezSedi BarnenezEau BarnenezGD..
...
venn_plotVerveur <- ggvenn(sets_listVerveur , show_elements = TRUE,
  ...
  stroke_linetype = "solid",
  set_name_color = "black",
  set_name_size = 2,  # Ajustez la taille de la police ici VerveurSedi VerveurEau VerveurGD..
  text_size = 2,  # Ajustez la taille de la police pour les genres
  label_sep = "
  ",
  count_column = NULL,
